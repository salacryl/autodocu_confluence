...
<tr>
<td class='confluenceTd'>Kategorie</td><td class='confluenceTd'>HyperV-Host</td>
</tr>
<tr>
...
Hyper-V ist eine Hypervisor-basierte Virtualisierungstechnik von Microsoft für Computer mit x64-fähigem x86-Prozessor. Erhältlich ist Hyper-V sowohl als fester Bestandteil der Serverbetriebssysteme (z. B. Windows Server 2016 Standard und Datacenter) als auch in Form der Standalone-Ausführung (z. B. Microsoft Hyper-V Server 2016). Darüber hinaus enthalten die Pro- und Enterprise-Editionen der Clientbetriebssysteme Windows 8 und Windows 10 die Hyper-V-Technologie.[1] In all diesen Produkten ist Hyper-V entweder standardmäßig aktiv oder bei Bedarf als Komponente installierbar. Die Standalone-Ausführung Microsoft Hyper-V Server 2016 ist kostenlos erhältlich und entspricht einer Windows Server 2016 Installation in der Core Edition ohne grafische Benutzeroberfläche und mit aktivierter Hyper-V Rolle.[2]
<h1>Applikation </h1> 
